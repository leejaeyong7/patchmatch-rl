...
class GRU(nn.Module):
    def __init__(self, input_channel, output_channel, kernel_size):
        ...
        self.gate_conv = nn.Conv2d(gru_input_channel, output_channel * 2, kernel_size, padding=kernel_size//2)
        ...
        self.output_conv = nn.Conv2d(gru_input_channel, output_channel, kernel_size, padding=kernel_size//2)
