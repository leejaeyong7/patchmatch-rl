...
def main(args):
    ...
    # setup model / trainer
    model = PatchMatchRL.load_from_checkpoint(str(checkpoint_file))
    ...
    output_path/ experiment_name / last.ckpt / maps / set_id / 
        000000_image.pth => 1x3xHxW tensor
        000000_depth_map.pth => 1x1xHxW tensor
        000000_normal_map.pth => 1x3xHxW tensor
